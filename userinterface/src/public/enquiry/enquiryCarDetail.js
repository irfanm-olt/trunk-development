...
componentDidUpdate( prevProps ) {
    // enquiry car success
    const { addEnquirySuccess, data } = this.props.data;
...
render() {
  const { manufacture, customer, vehicleLoading, car } = this.props.data;
  // car
              ...
              <CFade timeout={300} in={this.state.showElements} unmountOnExit={true}>
                <CCard>
                  <CCollapse show={this.state.collapsed} timeout={1000}>
                    <CCardBody>
                        <CFormGroup>
                          <CLabel htmlFor="select">Add chassis number</CLabel>
                          <div className="controls">
                            <CInputGroup>
                              <CInput 
                                type="text" 
